...
| モデルDL（**実測 v2.2**、WebGPU） | DA3-S q4f16 21 + MODNet 6.9 + MI-GAN 10.6 = **38.5 MB** → 約 15 s | +ISNet 44.35 = **82.9 MB** → 約 33 s |
| モデルDL（**実測 v2.2**、WASM） | DA3-S uint8 29 + MODNet 6.9 + MI-GAN 10.6 = **46.4 MB** → 約 19 s | +ISNet 44.35 = **90.8 MB** → 約 36 s |
